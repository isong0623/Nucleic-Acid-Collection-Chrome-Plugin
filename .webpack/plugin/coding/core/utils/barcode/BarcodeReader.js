...
BarcodeReader = {
  ...
  // Don't touch the canvas either.
  ScanCanvas: null,
  ScanContext: null,
  SquashCanvas: document.createElement("canvas"),
  // Callback for the decoding of an image.
  ImageCallback: null,
  // Callback for the decoding of a video.
  StreamCallback: null,
  // Callback for localization.
  LocalizationCallback: null,
  // The actual video.
  Stream: null,
  // Will be set to false when StopStreamDecode() is called.
  DecodeStreamActive: false,
  // Used to enfore the ForceUnique property.
  Decoded: [],
